...
Our result from testing the matlabfunction mesh can be seen in figure \ref{fig:meshCar} and our results from testing the matlabfunction surfl can be seen in figure \ref{fig:surflCar}
