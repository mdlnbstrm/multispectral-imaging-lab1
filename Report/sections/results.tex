...
We also studied at parts of images before and after dividing them with their own intensities as shown in figures \ref{fig:yellow}, \ref{fig:yellow-after} and \ref{fig:large-cropp}.
We also tested a method for highlighting selected colour as shown in figure \ref{fig:contrastex}. 
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.4\textwidth}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/y}
		\caption{}
		\label{fig:y-before}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-mean}
		\caption{}
		\label{fig:y-mean}
	\end{subfigure}
	\\
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-hist-r}
		\caption{}
		\label{fig:y-hist-r}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-hist-g}
		\caption{}
		\label{fig:y-hist-g}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-hist-b}
		\caption{}
		\label{fig:y-hist-b}
	\end{subfigure}
	\caption{(a) A yellow image (b) Mean spectrum of the image (c) Histogram for intensity of red (d) Histogram for intensity of green (e) Histogram for intensity of blue}
	\label{fig:yellow}
\end{figure}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-after}
		\caption{}
		\label{fig:y-after}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-after-mean}
		\caption{}
		\label{fig:y-after-mean}
	\end{subfigure}
	\\
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-after-hist-r}
		\caption{}
		\label{fig:y-after-hist-r}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-after-hist-g}
		\caption{}
		\label{fig:y-after-hist-g}
	\end{subfigure}
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\textwidth]{div-int/y-after-hist-b}
		\caption{}
		\label{fig:y-after-hist-b}
	\end{subfigure}
	\caption{Same image and corresponding diagram and histogram used in figure \ref{fig:yellow} but after dividing the image with its own intensity}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/cropp}
		\caption{}
		\label{fig:large-cropp-before}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{div-int/div-intens}
		\caption{}
		\label{fig:large-cropp-after}
	\end{subfigure}
	\caption{Before and after using the same method as in figure \ref{fig:yellow} and \ref{fig:yellow-after}}
...
\begin{figure}
	\centering
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{mytomatopicture}
		\caption{}
		\label{fig:tom}
	\end{subfigure}
	\begin{subfigure}[b]{0.4\textwidth}
		\includegraphics[width=\textwidth]{contrastex}
		\caption{}
		\label{fig:cont}
	\end{subfigure}
	\caption{Method for highlighting selected colour throughout the image}
